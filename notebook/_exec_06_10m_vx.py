"""Execute 06 trial 6 and embed the new GIF. Do not overwrite 06a-d."""
...
def main() -> None:
    ...
    for idx in CODE_IDX:
        ...
        gif = NB.parent / "assets/06e_trot_vx_flip.gif"
        if "06e_trot_vx_flip.gif" in src and gif.is_file():
            outputs.append(
                new_output(
                    "display_data",
                    data={
